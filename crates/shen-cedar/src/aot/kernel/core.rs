...
pub fn aot_shen_x2e_shendef_x2d__x3e_kldef(
    ...
    loop {
        break Ok({
            let __t180 = {
                let v_V529 = v_V529.clone();
                let v_V530 = v_V530.clone();
                rt::make_aot_closure(
                    "<lambda>",
                    1,
                    move |interp, args| {
                ...
                };
                {
                    let v_W556 = {
                        let __t235 = {
                            let v_V551 = v_V551.clone();
                            let v_V552 = v_V552.clone();
                            let v_W553 = v_W553.clone();
                            let v_W555 = v_W555.clone();
                            rt::make_aot_closure(
                                "<lambda>",
                                1,
                                move |interp, args| {
            ...
            if match rt::is_truthy(interp, &__t369) {
            ...
            } else {
                {
                    ...
                    if match rt::is_truthy(interp, &__t360) {
                        ...
                        break Ok({
                            let __t359 =
                                Value::Str(Rc::from("implementation error in shen.linearise"));
    ...
    loop {
        break Ok({
            let __t675 = {
                ...
                let __t673 = Value::Str(Rc::from(" is not a legitimate constructor\n"));
            ...
            };
            {
                ...
                };
                {
                    let v_W709 = {
                        ...
                        let __t739 = {
                            let __t728 = Value::Str(Rc::from("("));
                            let __t738 = {
                                let __t729 = Value::Str(Rc::from("f"));
                                let __t737 = {
                                    let __t730 = Value::Str(Rc::from("n"));
                                    let __t736 = {
                                        let __t731 = Value::Str(Rc::from(" "));
                                        let __t735 = {
                                            let __t733 = {
                    ...
                    if match rt::is_truthy(interp, &__t766) {
                    ...
                    } else {
                        {
                            ...
                            if match rt::is_truthy(interp, &__t748) {
                                ...
                                break Ok({
                                    let __t747 = {
                                        let __t742 = Value::Str(Rc::from("arity error in "));
                                        let __t746 = {
    ...
    loop {
        {
            ...
            if match rt::is_truthy(interp, &__t788) {
            ...
            } else {
                {
                    let _ = {
                        let __t794 = {
                            let __t789 = Value::Str(Rc::from("free variables in "));
                            let __t793 = {
                                let __t790 = v_V719.clone();
                                let __t791 = Value::Str(Rc::from(":"));
                    ...
                    };
                    {
                        let _ = {
                            let __t803 = {
                                let v_V719 = v_V719.clone();
                                let v_V720 = v_V720.clone();
                                rt::make_aot_closure(
                                    "<lambda>",
                                    1,
                                    move |interp, args| {
                                        ...
                                        Ok({
                                            let __t801 = {
                                                let __t796 = Value::Str(Rc::from(" "));
                                                let __t800 = {
                                                    let __t797 = v_Z721.clone();
                                                    let __t798 = Value::Str(Rc::from(""));
                                                    let __t799 =
                    ...
                    if match rt::is_truthy(interp, &__t1203) {
                    ...
                    } else {
                        {
                            ...
                            if match rt::is_truthy(interp, &__t1105) {
                                ...
                                break Ok({
                                    let __t1104 = Value::Str(Rc::from(
                                        "implementation error in shen.choicepoint",
                                    ));
            ...
            if match rt::is_truthy(interp, &__t1491) {
            ...
            } {
                {
                    ...
                    };
                    {
                        ...
                        break Ok({
                            let __t1489 = {
                                let v_V787 = v_V787.clone();
                                let v_W788 = v_W788.clone();
                                let v_W789 = v_W789.clone();
                                rt::make_aot_closure(
                                    "<lambda>",
                                    1,
                                    move |interp, args| {
                    ...
                    } {
                        {
                            ...
                            };
                            {
                                ...
                                break Ok({
                                    let __t1448 = {
                                        let v_V787 = v_V787.clone();
                                        let v_W791 = v_W791.clone();
                                        let v_W792 = v_W792.clone();
                                        rt::make_aot_closure(
                                            "<lambda>",
                                            1,
                                            move |interp, args| {
                                            ...
                                            if match rt::is_truthy(interp, &__t1523) {
                                            ...
                                            } else {
                                                {
                                                    ...
                                                    if match rt::is_truthy(interp, &__t1502) {
                                                        ...
                                                        break Ok({
                                                            let __t1501 = Value::Str(Rc::from("implementation error in shen.triple-stack"));
                                                            rt::apply_direct(
                                                                interp,
                                                                "simple-error",
                                                                &[__t1501],
                    ...
                    if match rt::is_truthy(interp, &__t1861) {
                    ...
                    } else {
                        {
                            ...
                            if match rt::is_truthy(interp, &__t1856) {
                                ...
                                break Ok({
                                    let __t1855 =
                                        Value::Str(Rc::from("factorise expects a + or a -\n"));
