    ...
    loop {
        {
            ...
            };
            {
                ...
                if match rt::is_truthy(interp, &__t770) {
                    ...
                    break Ok({
                        let __t771 = Value::str("input aborted\n");
    ...
    loop {
        {
            ...
            if match rt::is_truthy(interp, &__t777) {
                ...
                break Ok({
                    let __t778 = Value::str("maximum inferences exceeded");
