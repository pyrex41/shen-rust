...
//!
//! The JIT is reached through the *real* public tier-in: `SHEN_CEDAR_JIT` set →
...
use shen_cedar::aot::kernel::sys::aot_shen_x2e_length_x2d_h;
use shen_cedar::aot::runtime as rt;
...
fn length_h_jit_matches_aot() {
    ...
    // `set_var` is safe.
    std::env::set_var("SHEN_CEDAR_JIT", "1");
